...
Switch property `jakartasql.DataSource.test.dataSource.url` in `microprofile-config.properties`
to use a TCP connection:

```
jakartasql.DataSource.test.dataSource.url=jdbc:h2:tcp://localhost:1521/test
```
